<?php
/** @var $checks \common\modules\installer\helpers\SystemCheck */
/** @var $hasError \common\modules\installer\helpers\SystemCheck */
?>
<div class="panel panel-default">
    ...
    <div class="panel-body">
            ...
            <?= \yii\helpers\Html::a('<i class="fa fa-repeat"></i> ' . 'Check again', ['prerequisites'], ['class' => 'btn btn-info']) ?>

            <?php if (!$hasError) { ?>
                <?= \yii\helpers\Html::a('Next' . ' <i class="fa fa-arrow-circle-right"></i>', ['web-database'], ['class' => 'btn btn-primary']) ?>
            <?php } ?>
    </div>
</div>